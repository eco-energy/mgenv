...
{--
This module is a port of the constants defined in:
https://github.com/pingswept/pysolar/blob/master/pysolar/constants.py Copyright Brandon Stafford
...
earthRadius :: R
earthRadius = 6378140.0 -- Meters

earthAxisInclination :: R
earthAxisInclination = 23.45 -- Degrees

secondsPerDay :: Integer
secondsPerDay = 86400

standardPressure :: R
standardPressure = 101325.00 -- Pascals

standardTemperature :: R
standardTemperature = 288.15 -- Kelvin

celsiusOffset :: R
celsiusOffset = 273.15 -- sub from K to get deg C, add to deg C to get K

earthTemperatureLapseRate :: R
earthTemperatureLapseRate = (-0.0065) -- K/m

airGasConstant :: R
airGasConstant = 8.31432 -- Nm/s^2

earthGravity :: R
earthGravity = 9.80665 -- m/s^2 or N/kg

earthAtmosphereMolarMass :: R
...
heliocentricLongitudeCoeffs :: (RealFrac a) => [[(a, a, a)]]
heliocentricLongitudeCoeffs = [
        [  -- L0
            (175347046.0,0,0),
